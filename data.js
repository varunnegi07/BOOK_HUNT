...
const NCERT = {
  ...
  'cbse-7': [
    ...
    {id:'n703',title:'Our Pasts II (History)',author:'NCERT',code:'gehi1',ch:10,subject:'History',emoji:'📜',gradient:'linear-gradient(135deg,#fdcb6e,#e17055)',
    ...
    {id:'n704',title:'Honeycomb (English)',author:'NCERT',code:'gehl1',ch:10,subject:'English',emoji:'📖',gradient:'linear-gradient(135deg,#636e72,#b2bec3)',
     chapters:['Three Questions','A Gift of Chappals','Gopal and the Hilsa Fish','The Ashes That Made Trees Bloom','Quality','Expert Detectives','The Invention of Vita-Wonk','Fire: Friend and Foe','A Bicycle in Good Repair','The Story of Cricket']}
  ],
  'cbse-8': [
